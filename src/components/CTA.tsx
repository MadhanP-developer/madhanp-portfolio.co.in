    ...
    <section className="relative py-24">
      <div className="mx-auto max-w-6xl px-6">
        <div className="relative overflow-hidden rounded-3xl border border-border bg-card/40 p-12 backdrop-blur md:p-16">
          ...
          <div className="pointer-events-none absolute -bottom-32 right-1/4 h-72 w-72 rounded-full bg-pink opacity-30 blur-3xl animate-blob" style={{ animationDelay: "-6s" }} />
          ...
          >
            <h2 className="text-4xl font-bold md:text-6xl">Ready to build <span className="text-gradient">something amazing</span>?</h2>
            <p className="mx-auto mt-5 max-w-xl text-muted-foreground">Let's discuss your project — or just trade ideas about systems, scale, and shipping.</p>
            ...
            <div className="mt-9 flex flex-wrap justify-center gap-4">
              ...
              >
                Send a Message <FiArrowRight className="transition-transform group-hover:translate-x-1" />
              </a>
              <a
